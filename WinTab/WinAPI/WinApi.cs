...
public static class WinApi
{
    ...
    public const int WS_EX_TOOLWINDOW = 0x00000080; // Tool window (exclude from alt-tab)
    public const int WS_EX_APPWINDOW = 0x00040000; // Forces top-level window onto taskbar
