...
public static class Helper
{
    ...
    public static bool IsTimeUp(long startTicks, int timeMs) => StopwatchHelper.IsTimeUp(startTicks, timeMs);
    ...
    public static bool IsGeneralForeground(out nint foregroundWindow)
    {
        foregroundWindow = WinApi.GetForegroundWindow();
    ...
    public static bool HideWindow(nint hWnd, bool keepTheme = false)
    {
        try
        {
    ...
    public static bool IsCtrlShiftDown()
    {
        ...
        {
            _lastCtrlShiftCheckValue = false;
        }
