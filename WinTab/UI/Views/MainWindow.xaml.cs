...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        CbOpenCurrentTabOnNewTab.IsChecked = SettingsManager.OpenCurrentTabOnNewTab;
    ...
    private void SetupEventHandlers()
    {
        ...
        CbOpenCurrentTabOnNewTab.Checked += CbOpenCurrentTabOnNewTab_CheckedChanged;
        CbOpenCurrentTabOnNewTab.Unchecked += CbOpenCurrentTabOnNewTab_CheckedChanged;
    ...
    private void SetupLanguageSelector()
    {
        ...
        CbLanguage.Items.Add(new ComboBoxItem { Content = Application.Current.FindResource("Language_ZhCN"), Tag = "zh-CN" });
        CbLanguage.Items.Add(new ComboBoxItem { Content = Application.Current.FindResource("Language_EnUS"), Tag = "en-US" });
    ...
    {
        if (CbLanguage.SelectedItem is not ComboBoxItem { Tag: string lang }) return;
    ...
    {
        Title = (string)Application.Current.FindResource("App_Title");

        SetupLanguageSelector();

        _notifyIconManager.UpdateMenuItems(autoCheckParent: false);
        _notifyIconManager.SetTrayIconVisibility(visible: !SettingsManager.IsTrayIconHidden);
    }
    ...
    private void StartHooks()
    {
        ...
        _hookManager.StartGeneralWindowHost();
    }
    ...
    private void CbOpenCurrentTabOnNewTab_CheckedChanged(object? _, RoutedEventArgs __)
    {
        SettingsManager.OpenCurrentTabOnNewTab = CbOpenCurrentTabOnNewTab.IsChecked ?? false;
    }
    ...
    private void UpdateTrayIconVisibility(bool showAlert)
    {
        ...
        if (isChecked && showAlert && !SettingsManager.IsTrayIconHidden)
        {
            var message = canToggleVisibility
                ? string.Format((string)Application.Current.FindResource("Message_TrayHide_HotkeyHint"),
                    profile!.HotKeys!.HotKeysToString(profile.IsDoubleClick))
                : (string)Application.Current.FindResource("Message_TrayHide_NoHotkey");
