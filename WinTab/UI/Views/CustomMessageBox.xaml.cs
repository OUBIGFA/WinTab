...
public partial class CustomMessageBox : Window
{
    ...
    private void AddButtons(MessageBoxButton buttons, MessageBoxResult defaultButton = MessageBoxResult.None)
    {
        ...
        switch (buttons)
        {
            case MessageBoxButton.OK:
                AddButton(GetButtonText("Common_OK"), MessageBoxResult.OK, defaultButton is MessageBoxResult.None or MessageBoxResult.OK);
                break;
            case MessageBoxButton.OKCancel:
                AddButton(GetButtonText("Common_OK"), MessageBoxResult.OK, defaultButton is MessageBoxResult.None or MessageBoxResult.OK);
                AddButton(GetButtonText("Common_Cancel"), MessageBoxResult.Cancel, defaultButton is MessageBoxResult.Cancel);
                break;
            case MessageBoxButton.YesNo:
                AddButton(GetButtonText("Common_Yes"), MessageBoxResult.Yes, defaultButton is MessageBoxResult.None or MessageBoxResult.Yes);
                AddButton(GetButtonText("Common_No"), MessageBoxResult.No, defaultButton is MessageBoxResult.No);
                break;
    ...
    private static string GetButtonText(string key)
    {
        try
        {
