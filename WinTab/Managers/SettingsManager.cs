...
public static class SettingsManager
{
    ...
    public static bool OpenCurrentTabOnNewTab
    {
        get => Settings.OpenCurrentTabOnNewTab;
        set
        {
            Settings.OpenCurrentTabOnNewTab = value;
            SaveSettings();
            NotifyStaticPropertyChanged();
        }
    }
...
internal class AppSettings
{
    ...
    public bool OpenCurrentTabOnNewTab { get; set; } = true;
}
