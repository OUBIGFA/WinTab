...
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -Command ""$ErrorActionPreference = 'Stop'; $zipFile = '{app}\*.zip'; Expand-Archive -Path $zipFile -DestinationPath '{app}' -Force; Remove-Item -Path $zipFile -Force"""; StatusMsg: "{cm:ExtractingFiles}"; Flags: runhidden
