...
# Check Windows version - WinTab requires Windows 11 (Build 22621 or later)
$osVersion = [System.Environment]::OSVersion.Version
$buildNumber = $osVersion.Build
if ($osVersion.Major -lt 10 -or ($osVersion.Major -eq 10 -and $buildNumber -lt 22621))
{
    Write-Warning "WinTab requires Windows 11 (Build 22621 or later). Current OS: Windows $( $osVersion.Major ).$( $osVersion.Minor ) Build $buildNumber"
...
Write-Host ""
Write-Host "WinTab has been installed successfully!" -ForegroundColor Green
